...
def GetYellowInnerEdge(OuterLanes,MidLane,OuterLane_Points):
    ...
    if Mid_cnts:
        ...
        if  (len(OuterLane_Points)==2):  ## if 2 lines are detected as outerlane , then find the neares outerlane
        ...
        ### draw a line at mid of the camera , and check if the outerlane crosses it,
        ### if it crosses it , then it is not the correct outerlane
